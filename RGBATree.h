...
namespace TilerUtils {
	...
	private:
		...
		void constructTree(int start, int end, unsigned char d);
		...
		void quickSelect(int start, int end, int k, unsigned char d);

		unsigned partition(int lo, int hi, unsigned char d);
